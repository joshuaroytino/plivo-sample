...
<Response>
    ...
    <Conference enterSound="beep:2" record="true" action="https://glacial-harbor-8656.herokuapp.com/testing.php/response/conf_action" 
        method="GET" callbackUrl="https://glacial-harbor-8656.herokuapp.com/testing.php/response/conf_callback" 
        callbackMethod="GET" startConferenceOnEnter="true" endConferenceOnExit="true">demo</Conference>
</Response>
